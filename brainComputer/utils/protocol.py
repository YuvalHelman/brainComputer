...
#
#
# def combine_dicts(user_dict: dict, snap_dict: dict):
#     return dict(
#         user=user_dict,
#         snapshot=snap_dict
#     )
...
#
#     @classmethod
#     def pb_to_dict(cls, pb_snapshot):
#         # TODO: save color_image and depth_image data to disk
#
#         return dict(
#             timestamp=pb_snapshot.datetime,
#             pose=dict(
#                 translation=dict(
